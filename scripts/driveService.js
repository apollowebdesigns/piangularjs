...
function driveService ($http, $log, rewindFactory) {
    ...
    function _driveData() {
        ...
        return $http.get("http://localhost:8888/hits/motor")
    ...
    function _driveForwards(flag) {
        ...
        return $http.get("http://localhost:8888/hits/forwards")
        .then(function(response) {
    ...
    function _driveBackwards(flag) {
        ...
        return $http.get("http://localhost:8888/hits/backwards")
        .then(function(response) {
    ...
    function _driveRight(flag) {
        ...
        return $http.get("http://localhost:8888/hits/right")
        .then(function(response) {
            $log.info('right hit');
    ...
    function _driveLeft(flag) {
        ...
        return $http.get("http://localhost:8888/hits/left")
        .then(function(response) {
            $log.info('left hit');
    ...
    function getRewind(arg) {
        switch(arg) {
            case "http://localhost:8888/hits/backwards":
                return _driveBackwards("flagged");
                break;
            case "http://localhost:8888/hits/forwards":
                return _driveForwards("flagged");
                break;
            case "http://localhost:8888/hits/left":
                return _driveLeft("flagged");
                break;
            case "http://localhost:8888/hits/right":
    ...
    function _rewind() {
        $log.info('left function entered');
        return $http.get("http://localhost:8888/hits/rewind")
            .then(function(response) {
